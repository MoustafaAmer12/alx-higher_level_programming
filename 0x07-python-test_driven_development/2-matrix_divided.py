#!/usr/bin/python3
"""
Matrix divided Module includes function for dividing
...
def matrix_divided(matrix, div):
    """
    Returns:
        new_matrix with the result of the divided matrix
    """
...
(list of lists) of integers/floats")
    ...
    new_matrix = [[round(matrix[i][j] / div, 2) for j in range(size)]
                  for i in range(len(matrix))]
    return new_matrix
